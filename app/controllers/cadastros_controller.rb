class CadastrosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @cadastro.save
        format.html { redirect_to root_path, notice: 'Cadastro criado com sucesso!' }
  ...
  def update
    respond_to do |format|
      if @cadastro.update(cadastro_params)
        format.html { redirect_to root_path, notice: 'Cadastro alterado com sucesso!' }
  ...
  def destroy
    @cadastro.destroy
    respond_to do |format|
      format.html { redirect_to root_path, notice: 'Cadastro excluido com sucesso!' }
  ...
  private
    ...
    def cadastro_params
      params.require(:cadastro).permit(:nome, :descricao, :valor, :inicio, :fim, :cidade)
    end
end
